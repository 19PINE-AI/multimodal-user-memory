...
\section{Decomposing perceptual recall: localization and identification}
\label{sec:why}
...
\section{A factored architecture for perceptual memory}
\label{sec:method}
...
\subsection{Factored localization recovers oracle recognition in cluttered scenes}
\label{sub:factored}
