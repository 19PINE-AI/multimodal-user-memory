    ...
    <section id="reproducibility" className="py-16 px-6 bg-gray-50 border-y border-gray-100">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-sm text-gray-600 -mt-2 mb-6">
          <a href={PAPER.abstractUrl} target="_blank" rel="noopener noreferrer" className="text-brand hover:underline">arXiv abstract</a>
          {' · '}
          <a href={PAPER.pdfUrl} target="_blank" rel="noopener noreferrer" className="text-brand hover:underline">PDF</a>
          {' · '}
          <a href={PAPER.repositoryUrl} target="_blank" rel="noopener noreferrer" className="text-brand hover:underline">GitHub repository</a>
        </p>
